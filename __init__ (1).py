...
FEATURE_NAMES = [
    "tipo_sistema", "tecnologia", "num_modulos",
    "complejidad", "tamano_equipo",
...
def get_trained_model():
    ...
    X = df[["tipo_enc","tech_enc","num_modulos","complejidad",
            "tamano_equipo","duracion_real_dias","num_tareas_asana"]]
    y = df["esfuerzo_horas"]
...
def predict_effort(tipo, tecnologia, num_modulos, complejidad, tamano_equipo,
    ...
    X = np.array([[tipo_enc, tech_enc, num_modulos, complejidad,
                   tamano_equipo, duracion_dias, num_tareas]], dtype=float)
